function isNumberPrime(number) { // функция принимает любое число в диапазоне [1, 1000] и определяет, является ли оно простым или составным
  if (number > 1000 ) {
    ...
    for (let i = 2; i < number; i++) { // в цикле перебрать все числа от 2 до этого числа
      if (number % i === 0) {
